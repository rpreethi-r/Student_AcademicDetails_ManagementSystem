...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css"> <style media="screen">
*,
*:before,
*:after{
padding: 0;
...
<input type="text" name="door" value="Door no." /><br><br>
...
<input type="number" name="pin" value="Pin code" /><br><br>
