...
<div class="basic">
<center><h2>Semester 4 Details</h2></center>
<?php
...
$grade = $_POST['grade'];
$att = $_POST['att'];
$sql = "INSERT INTO sem_4"."(reg_no,sub_name,sub_code,credits,internal_mark,grade,attendance)". "VALUES('$reg','$sub','$subcode','$credits','$internal','$grade','$att')";
