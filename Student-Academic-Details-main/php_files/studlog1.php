...
<body translate="no" >
  ...
  <h1 class="section-title">Student</h1>
  <div class="forms">
    <div class="form-wrapper is-active">
      ...
      <form class="form form-login" method = 'post' action = "login_student.php">
        <fieldset>
      ...
      <form class="form form-signup" method="post" action ="signup_student.php">
        <fieldset>
          <legend>Enter details for sign up.</legend>
		  <div class="input-block">
            <label for="ad">Student ID</label>
