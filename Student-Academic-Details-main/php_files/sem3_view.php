<!doctype html>
<head><title>Semester 3</title></head>
<body bgcolor="C0C0C0">
<style>
table, th ,td {
...
$reg = $_SESSION['reg'];
$sql = " select reg_no,sub_name,sub_code,credits,internal_mark,grade,attendance from sem_3 where reg_no = '$reg'";
...
echo "<br><br><h2>Your SGPA for semester 3 is: ".$sgpa."</h2>";
mysqli_close($link);
$link = mysqli_connect("localhost", "root","",'student_det');
...
$sql1 = "INSERT INTO sem_gpa"."(reg_no,semester,sgpa)". "VALUES($reg,'3','$sgpa')";
