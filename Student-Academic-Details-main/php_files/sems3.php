...
$grade = $_POST['grade'];
$att = $_POST['att'];
$sql = "INSERT INTO sem_3"."(reg_no,sub_name,sub_code,credits,internal_mark,grade,attendance)". "VALUES('$reg','$sub','$subcode','$credits','$internal','$grade','$att')";
